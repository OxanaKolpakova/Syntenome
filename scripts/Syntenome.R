...
source("./read_and_combine_gtf.R")
source("./get_centered_df_by_gene.R")
source("./get_centered_df_by_product.R")
source("./create_contig_boundaries.R")
source("./filter_by_coordinates.R")
source("./plot_gtf.R")
source("./sigmotize.R")
source("./tanhize.R")
source("./plot_preview.R")
source("./concatenate_contigs.R")
...
server <- function(input, output, session) {
  ...
  observeEvent(input$use_test_data, {
    test_data_dir <- "../data"  # Specify the path to your test data
