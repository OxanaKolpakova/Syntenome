  ...
  tabsetPanel(
    ...
    tabPanel("Plot Options & Main View",
             sidebarLayout(
               sidebarPanel(
                 h4("Plot Options"),
                 selectInput("center_by", "Center by:",
                 ...
                 selectInput("color_by", "Color By:",
                             choices = list("Gene" = "gene", "Product" = "product", 
                                            ...
                                            "Protein ID" = "protein_id", "Width" = "width", "Strand" = "strand", 
                                            "GB Key" = "gbkey", "Locus Tag" = "locus_tag"),
                             selected = "gene"),
                 checkboxInput("show_legend", "Show Legend", value = TRUE),
                 checkboxInput("show_borders", "Show Borders", value = TRUE),
                 checkboxInput("show_strand_directions", "Show Strand Directions", value = TRUE),
                 hr(),
                 h4("Track Options"),
